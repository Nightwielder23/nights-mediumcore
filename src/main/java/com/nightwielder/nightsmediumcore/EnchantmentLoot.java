...
public class EnchantmentLoot
{
    ...
    public static void onLootLoad(LootTableLoadEvent event)
    {
        ...
        if (STRONGHOLD_LIBRARY.equals(name))
            ...
            event.getTable().addPool(bookPool("nightsmediumcore_lifesteal_book", "nightsmediumcore:lifesteal", 0.02F));
        else if (ANCIENT_CITY.equals(name))
            event.getTable().addPool(bookPool("nightsmediumcore_lifesteal_book", "nightsmediumcore:lifesteal", 0.01F));
    }
